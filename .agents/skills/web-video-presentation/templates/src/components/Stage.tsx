...
import { DotFlowCanvas } from "./DotFlowCanvas";
 ...
 *
 * DotFlowCanvas: rendered only when theme sets --surface-pattern: none
 * AND --dot-flow: 1 (opt-in). Themes without these vars get the classic
 * CSS ::after pattern layer (or no pattern).
 */
