...
11 套初始主题，每个都有**独立的设计 DNA** —— 不是简单的换色版。挑一个
...
| id                  | 性格                                                                                                                                                                                                              |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ai-latent-space`   | 现代 AI / 科技。深海军蓝 + 天蓝强调色 + Inter 800。**两层神经节点点阵**贴在舞台上，玻璃卡片带**天蓝边框光晕**是签名。Apple-standard 缓动，中速节奏。适合 AI 研究 / 大模型 / 数据科学演讲。                       |
...
| 目标情绪                            | 起点                |
| ----------------------------------- | ------------------- |
| AI / 科技 / 神经网络 / 数据科学     | `ai-latent-space`   |
